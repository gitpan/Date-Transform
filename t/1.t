...
use lib '/Documents and Settings/Christopher Brown/Desktop/CPAN';
...
my $dt = new Date::Transform('%B/%e/%y %i:%M:%S %p', '%a %A %b %B %c %d %H %I %j %m %M %p %S %U %w %W %x %X %y %Y %Z');
ok( defined $dt, "Date::Transform::new(). ");	# Object successfully constructed.
